  ...
  return (
    <main className="mx-auto w-full max-w-6xl space-y-8 px-5 py-10 sm:px-10">
      <header className="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-300 pb-6 dark:border-zinc-700">
        <div>
          <p className="text-sm font-semibold tracking-widest">ZERO COUNCIL · FIXTURE</p>
          <h1 className="mt-2 text-3xl font-bold">Nhiều góc nhìn. Quyết định của bạn.</h1>
        </div>
        <Link href="/" className="rounded-full border px-4 py-2 text-sm">Mở UI prototype</Link>
      </header>

      <p className="max-w-3xl text-lg">Trang so sánh cũ. Dữ liệu viết sẵn, không gọi AI; tải lại trang sẽ xóa trạng thái bản mẫu.</p>
